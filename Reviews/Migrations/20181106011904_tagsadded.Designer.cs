...
namespace Reviews.Migrations
{
    ...
    [Migration("20181106011904_tagsadded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reviews.Models.ReviewTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasData(
                        ...
                        new { Id = 4, ReviewId = 4, TagId = 1 },
                        new { Id = 5, ReviewId = 2, TagId = 2 },
                        new { Id = 6, ReviewId = 4, TagId = 2 },
            ...
            modelBuilder.Entity("Reviews.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Text = "6 string" },
                        new { Id = 2, Text = "Ibanez" },
                        new { Id = 3, Text = "Yamaha" }
                    );
                });
            ...
            modelBuilder.Entity("Reviews.Models.ReviewTag", b =>
                {
                    ...
                    b.HasOne("Reviews.Models.Tag", "Tag")
                        .WithMany("ReviewTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
